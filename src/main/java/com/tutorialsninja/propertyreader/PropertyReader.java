...
public class PropertyReader {
    //implementing java singleton class
    /*
...
//here to get the path of the config properties right click on config.properties file and right click
        // and copy path - path from content root and add a / before src
